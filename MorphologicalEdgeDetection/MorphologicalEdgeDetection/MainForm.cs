            ...
            if (selectedSource != null)
            {
                ...
                else
                {
                    ...
                    if(Int32.TryParse(cmbFilterSize.SelectedItem.ToString(), out filterSize))
                    {
                        ...
                        {
                            bitmapResult = selectedSource.DilateAndErodeFilter(filterSize, ExtBitmap.MorphologyType.Dilation, chkB.Checked, chkG.Checked, chkR.Checked, edgeType);
                        }
                        else if (rdErode.Checked == true)
                        {
                            bitmapResult = selectedSource.DilateAndErodeFilter(filterSize, ExtBitmap.MorphologyType.Erosion, chkB.Checked, chkG.Checked, chkR.Checked, edgeType);
                        }
