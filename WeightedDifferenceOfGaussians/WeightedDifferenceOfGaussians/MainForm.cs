...
namespace WeightedDifferenceOfGaussians
{
    public partial class MainForm : Form
    {
        ...
        {
            if (previewBitmap == null || cmbKernelLenght.SelectedIndex == -1)
            {
                return;
            }
            ...
            {
                bitmapResult = selectedSource.DifferenceOfGaussianFilter(lenght, (double)numWeight1.Value, (double)numWeight2.Value);
            }
