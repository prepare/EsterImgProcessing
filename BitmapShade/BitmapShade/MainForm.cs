...
namespace BitmapShading
{
    public partial class MainForm : Form
    {
        ...
        private void ApplyFilter(bool preview)
        {
            ...
            float blue = trcBlue.Value / 100.0f;
            float green = trcGreen.Value / 100.0f;
            float red = trcRed.Value / 100.0f;

            if (preview == true)
            {
                picPreview.Image = previewBitmap.ColorShade(blue, green, red);
            }
            else
            {
                resultBitmap = originalBitmap.ColorShade(blue, green, red);
            }
        }
